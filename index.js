...
const colors = ["red", "orange", "yellow", "green", "blue", "indigo", "violet", "purple", "pink", "turquoise", "cyan", "magenta", "lime", "teal", "maroon", "navy", "gold", "silver", "gray", "black"];
...
rl.question("Please enter your name: ", (userName) => {
    ...
    rl.question(`Hello ${userName}! Please enter your favorite color: `, (userColor) => {
        // Check if the entered color exists in the array
        const index = colors.findIndex(color => color.toLowerCase() === userColor.toLowerCase());
